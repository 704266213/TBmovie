...
import com.golove.R;
import com.golove.ui.reflesh.indicator.PtrIndicator;
import com.golove.ui.reflesh.util.PtrCLog;
 ...
 * It defines { in.srain.cube.views.ptr.PtrUIHandler}, which allows you customize the UI easily.
 */
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ((((moveUp && canMoveUp) || moveDown) && (Math.abs(offsetY) >= Math.abs(offsetX)))){
                    movePos(offsetY);
                    return true;
                }
        }
