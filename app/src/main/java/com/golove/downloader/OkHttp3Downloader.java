package com.golove.downloader;
import android.content.Context;
import android.net.Uri;
import android.os.StatFs;

import com.golove.interceptor.NativeCacheInterceptor;
...
public final class OkHttp3Downloader implements Downloader {
    ...
    private static final int EFFECTIVE_TIME = 1 * 24 * 60 * 60; // 1天有效期
    ...
    private static OkHttpClient createOkHttpClient(File cacheDir, long maxSize) {
        return new OkHttpClient.Builder()
                ...
                .addNetworkInterceptor(new NativeCacheInterceptor(EFFECTIVE_TIME))
                .build();
    }
    ...
    @Override public Response load(Uri uri, int networkPolicy) throws IOException {
        ...
        //这里的fromCache为true则说明该图片是从okhttp3的磁盘缓存中读出来的，一般重启app加载同一个url的图片会这样，反之就是从网上现下的
